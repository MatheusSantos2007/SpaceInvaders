...
# SPRINGREEN ALTERADO DE 154 PARA 155
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 5):
        ...
        self.__sound_shot = pygame.mixer.Sound(DIRECTORY + "/sounds/pancadachaves.wav")
        self.__ship_explosion = pygame.mixer.Sound(DIRECTORY + "/sounds/seumadruga.wav")
    ...
    def shoot(self):
        ...
        bullet = Bullet(self.rect.midtop, 9)
        return bullet
...
class Invader(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite, pos_x, pos_y, speed = 2):
        """
...
class SpaceInvaders():
    ...
    def home_screen(self):
        ...
        text = self.font.render("MADRUGUINHA GAMES", True, GREEN)
        self.font = self.create_font(20)
        command1 = self.font.render(" ENTER : MADRUGAR ", True, WHITE, None)
        command2 = self.font.render("   ESC : NOOOSSA!!      ", True, WHITE, None)
    ...
    def check_collisions(self):
        ...
        if pygame.sprite.groupcollide(self.mystery, self.ship_shot, True, True):
            self.score += choice([25, 35, 45, 55,100,400,800,2000])
        ...
        for atingidos in pygame.sprite.groupcollide(self.ship_shot, self.invaders, True, True).values():
            for invasor in atingidos:
                ...
                self.score += choice([1000, 150, 200, 250, 300, 350, 400,1000,2000,5000])
